...
$(document).ready(function(){function e(){var i="May 31,2015 23:59",t=new Date(i),n=new Date,s=t-n;if(a=s,t>n){var r=parseInt(s/864e5);10>r&&(r="0"+r),r=r.toString();var l=parseInt(s/36e5)%24;10>l&&(l="0"+l),l=l.toString();var c=parseInt(s/6e4)%60;10>c&&(c="0"+c),c=c.toString();var p=parseInt(s/1e3)%60;10>p&&(p="0"+p),p=p.toString(),9==r[1]&&2==l[0]&&3==l[1]&&5==c[0]&&9==c[1]&&5==p[0]&&9==p[1]?o($("#day0"),r[0]):$("#day0").html(r[0]),2==l[0]&&3==l[1]&&5==c[0]&&9==c[1]&&5==p[0]&&9==p[1]?o($("#day1"),r[1]):$("#day1").html(r[1]),3==l[1]&&5==c[0]&&9==c[1]&&5==p[0]&&9==p[1]?o($("#hour0"),l[0]):$("#hour0").html(l[0]),5==c[0]&&9==c[1]&&5==p[0]&&9==p[1]?o($("#hour1"),l[1]):$("#hour1").html(l[1]),9==c[1]&&5==p[0]&&9==p[1]?o($("#min0"),c[0]):$("#min0").html(c[0]),5==p[0]&&9==p[1]?o($("#min1"),c[1]):$("#min1").html(c[1]),9==p[1]?o($("#sec0"),p[0]):$("#sec0").html(p[0]),o($("#sec1"),p[1]),setTimeout(e,1e3)}else $(".timer").html("<p id='stop'>Отсчет закончен!!!</p>")}function o(e,o){e.html(o).css({marginTop:"0px"}).animate({marginTop:"0px"})}e(),$("nav ul li:eq(0), footer .list ul li:eq(0)").on("click",function(){$("body, html").stop().animate({scrollTop:$(".wrapp-action .action h1").offset().top-100+"px"},400)}),$("nav ul li:eq(1), footer .list ul li:eq(1)").on("click",function(){$("body, html").stop().animate({scrollTop:$(".wrapp-assortment h1").offset().top-115+"px"},400)}),$("nav ul li:eq(2), footer .list ul li:eq(2)").on("click",function(){$("body, html").stop().animate({scrollTop:$(".wrapp-work h1").offset().top-120+"px"},400)}),$("nav ul li:eq(3), footer .list ul li:eq(3)").on("click",function(){$("body, html").stop().animate({scrollTop:$(".wrapp-objects h1").offset().top-120+"px"},400)}),$("nav ul li:eq(4), footer .list ul li:eq(4)").on("click",function(){$("body, html").stop().animate({scrollTop:$(".wrapp-partners h1").offset().top-120+"px"},400)}),$("nav ul li:eq(5), footer .list ul li:eq(5)").on("click",function(){$("body, html").stop().animate({scrollTop:$(".wrapp-service h1").offset().top-120+"px"},400)}),$("nav ul li:eq(6), footer .list ul li:eq(6)").on("click",function(){$("body, html").stop().animate({scrollTop:$(".wrapp-places h1").offset().top-120+"px"},400)}),$("nav ul li:eq(7), footer .list ul li:eq(7)").on("click",function(){$("body, html").stop().animate({scrollTop:$(".wrapp-map h1").offset().top-150+"px"},400)}),$(".btn-obr-question").on("click",function(){$("body, html").stop().animate({scrollTop:$(".size-house h1").offset().top-100+"px"},400)}),$("nav ul li").hover(function(){var e=$(this);e.stop().animate({"background-color":"#f7f7f7"},100),e.children(".stick").stop().animate({bottom:"0px"},100)},function(){var e=$(this);e.stop().animate({"background-color":"white"},100),e.children(".stick").stop().animate({bottom:"-4px"},100)}),$(".action-slider").slidesjs({width:800,height:308,navigation:{active:!1,effect:"slide"},play:{active:!0,effect:"slide",interval:7e3,auto:!0,swap:!1,pauseOnHover:!1}}),$(".slider").slidesjs({width:1920,height:735,navigation:{active:!0,effect:"slide"},play:{active:!1,effect:"fade",interval:5e3,auto:!0,swap:!1,pauseOnHover:!1},effect:{fade:{speed:1e3}}}),$(".slider").append('<div class="wrapp-slider"><div class="slider-nav"></div><div class="slider-bg"></div></div>'),$(".slider .slidesjs-previous.slidesjs-navigation").appendTo(".wrapp-slider .slider-nav"),$(".slider .slidesjs-next.slidesjs-navigation").appendTo(".wrapp-slider .slider-nav"),$(".slider .slidesjs-pagination").appendTo(".wrapp-slider .slider-nav"),$(".elem-about").hover(function(){$(this).children(".block-about").children(".icon-about").children(".bg-about").css({background:"#dd2a1a",opacity:"1"}),$(this).children(".block-about").children(".arrow-about").children("img").attr("src","img/about/arrow-hover.png")},function(){$(this).children(".block-about").children(".icon-about").children(".bg-about").css({background:"#ebebeb",opacity:"0.25"}),$(this).children(".block-about").children(".arrow-about").children("img").attr("src","img/about/arrow.png")}),$(".spoiler-main-slider").slidesjs({width:256,height:174,navigation:{active:!0,effect:"slide"},pagination:{active:!1}}),$(".spoiler-content").mCustomScrollbar({theme:"minimal-dark"}),$(".slidesjs-container").append("<div class='description'><p class='des-content'></p><div class='des-bg'></div></div>");var i,t,n=0,s=function(){$(".des-content").text(null!=t.data("des")?t.data("des"):"")},r=function(e){t=$(".spoiler-main-slider:eq("+e+") img"),i=t.length,$(".des-content").text(t.data("des"))},l=function(){t=t.next(),s()},c=function(){t=t.prev(),s()};$(".slidesjs-next").on("click",function(){n+1>=i?$(".description p").stop().animate({opacity:"0"},250,function(){n=0,t=$(".spoiler-main-slider:eq("+D+") img:eq(0)"),s(),$(".description p").stop().animate({opacity:"1"},250)}):$(".description p").stop().animate({opacity:"0"},250,function(){n++,l(),$(".description p").stop().animate({opacity:"1"},250)})}),$(".slidesjs-previous").on("click",function(){0>n-1?$(".description p").stop().animate({opacity:"0"},250,function(){n=i-1,t=$(".spoiler-main-slider:eq("+D+") img:eq("+n+")"),s(),$(".description p").stop().animate({opacity:"1"},250)}):$(".description p").stop().animate({opacity:"0"},250,function(){n--,c(),$(".description p").stop().animate({opacity:"1"},250)})});var p,d,u,m=function(e){return 4>e?f:8>e?g:12>e?h:16>e?v:20>e?b:24>e?k:28>e?w:void 0},f=$(".wrapp-spoiler.top-spoiler"),g=$(".wrapp-spoiler.center-spoiler"),h=$(".wrapp-spoiler.bottom-spoiler"),v=$(".wrapp-spoiler.1-facade"),b=$(".wrapp-spoiler.2-facade"),k=$(".wrapp-spoiler.3-facade"),w=$(".wrapp-spoiler.4-facade");$(".block-content").on("click",function(){n=0;var e=$(this).index(".block-content"),o=$(".icon-block:eq("+e+")");if(D=e,u=m(e),null==p)$(".des-content").text(""),r(e),$(".spoiler-slider:eq("+e+")").css("display","block"),$(".spoiler-main:eq("+e+")").css("display","block"),$(".elem-arrow img:eq("+e+")").css("display","block"),o.addClass("active"),u.stop().slideDown(300),p=e,d=u;else if(p==e)o.removeClass("active"),p=null,u.stop().slideUp(300,function(){$(".spoiler-slider").css("display","none"),$(".spoiler-main").css("display","none"),$(".elem-arrow img").css("display","none")});else if(p!=e){var i=p;o.addClass("active"),$(".icon-block:eq("+i+")").removeClass("active"),d!=u?(d.slideUp(300,function(){$(".des-content").text(""),r(e),$(".spoiler-slider:eq("+i+")").css("display","none"),$(".spoiler-main:eq("+i+")").css("display","none"),$(".elem-arrow img:eq("+i+")").css("display","none")}),$(".spoiler-slider:eq("+e+")").css("display","block"),$(".spoiler-main:eq("+e+")").css("display","block"),$(".elem-arrow img:eq("+e+")").css("display","block"),u.slideDown(300)):d.slideUp(300,function(){$(".des-content").text(""),r(e),$(".spoiler-slider:eq("+i+")").css("display","none"),$(".spoiler-main:eq("+i+")").css("display","none"),$(".elem-arrow img:eq("+i+")").css("display","none"),$(".spoiler-slider:eq("+e+")").css("display","block"),$(".spoiler-main:eq("+e+")").css("display","block"),$(".elem-arrow img:eq("+e+")").css("display","block"),u.slideDown(300)}),d=u,p=e}}),$(".spoiler-title img").on("click",function(){d.slideUp(300,function(){$(".wrapp-spoiler").css("display","none"),$(".spoiler-slider").css("display","none"),$(".spoiler-main").css("display","none"),$(".elem-arrow img").css("display","none")}),$(".icon-block").removeClass("active"),p=null,d=null});var y=0,x=1;$(".facade, .title-img-assort img:eq(1)").on("click",function(){1===x&&($(".facade").addClass("active"),$(".krovel").removeClass("active"),$(".content-krovel").slideUp(300,function(){$(".wrapp-spoiler").css("display","none"),$(".spoiler-slider").css("display","none"),$(".spoiler-main").css("display","none"),$(".elem-arrow img").css("display","none"),p=null,d=null}),$(".content-facade").slideDown(300),x=0,y=1)}),$(".krovel, .title-img-assort img:eq(0)").on("click",function(){1===y&&($(".krovel").addClass("active"),$(".facade").removeClass("active"),$(".content-krovel").slideDown(300),$(".content-facade").slideUp(300,function(){$(".wrapp-spoiler").css("display","none"),p=null,d=null}),x=1,y=0)}),$(".elem-work").hover(function(){$(this).children(".work-block").stop().animate({backgroundColor:"#dd2a1a"},100)},function(){$(this).children(".work-block").stop().animate({backgroundColor:"#818281"},100)}),$(".slider-objects").slick({autoplay:!0,autoplaySpeed:3e3,dots:!0,infinite:!0,speed:300,slidesToShow:1,centerMode:!0,variableWidth:!0}),$(".slider-clients").slick({dots:!0,infinite:!0,speed:300,slidesToShow:1,centerMode:!0,variableWidth:!0}),$(".slider-partners").slick({dots:!0,infinite:!0,speed:300,slidesToShow:1,centerMode:!0,variableWidth:!0});var q=0,S=setInterval(function(){$(".loading").css("background-position","0px "+q+"px"),q+=40,q>480&&(q=0)},50),I=function(){S=setInterval(function(){$(".loading").css("background-position","0px "+q+"px"),q+=40,q>480&&(q=0)},200)},T=["поставка алюминиевых композитных панелей","поставка и монтаж алюминиевых композитных панелей","поставка и монтаж алюминиевых композитных панелей","поставка керамогранита","поставка алюминиевых композитных панелей","поставка и монтаж алюминиевых композитных панелей","поставка и монтаж алюминиевых композитных панелей","поставка алюминиевых композитных панелей","поставка алюминиевых композитных панелей","поставка и монтаж кровли и фасада","поставка кровли и алюминиевых композитных панелей","поставка и монтаж алюминиевых композитных панелей","","","",""],j=$(".galerey").data("sum"),C=1;$(".slider-objects img").on("click",function(){blockScroll(),$(".wrapp-galerey").fadeIn(200),$(".galerey").css("display","none"),$(".loading").fadeIn(200),I();var e=$(this).data("index");console.log(e),C=e+1,$(".galerey h1").text(T[e]),$(".image-g").attr("src","img/galerey/"+C+".jpg");var o=$(".image-g");if("frame active"!=$(".frame:eq("+e+")").attr("class"))o.load(function(){$(".galerey").fadeIn(200),$(".frame:eq("+e+")").addClass("active");var o=$(".galerey");o.css("dislplay","block");var i=o.width()+20,a=o.height()+20;o.css("margin-top",-a/2+"px"),o.css("margin-left",-i/2+"px"),$(".loading").fadeOut(200),clearInterval(S)});else{$(".galerey").fadeIn(200),$(".frame:eq("+e+")").addClass("active");var i=$(".galerey");i.css("dislplay","block");var a=i.width()+20,t=i.height()+20;i.css("margin-top",-t/2+"px"),i.css("margin-left",-a/2+"px"),$(".loading").fadeOut(200),clearInterval(S)}}),$(".arrow-right-g").on("click",function(){I(),$(".loading").fadeIn(200),C+1>j?C=1:C++,$(".galerey").fadeOut(200,function(){$(".image-g").attr("src","img/galerey/"+C+".jpg"),$(".galerey h1").text(T[C]);var e=$(".image-g");e.load(function(){$(".galerey").fadeIn(200);var e=$(".galerey"),o=e.width()+20,i=e.height()+20;e.css("margin-top",-i/2+"px"),e.css("margin-left",-o/2+"px"),$(".loading").fadeOut(200),clearInterval(S)})})}),$(".arrow-left-g").on("click",function(){I(),$(".loading").fadeIn(200),1>C-1?C=j:C--,$(".galerey").fadeOut(200,function(){$(".image-g").attr("src","img/galerey/"+C+".jpg"),$(".galerey h1").text(T[C]);var e=$(".image-g");e.load(function(){$(".galerey").fadeIn(200);var e=$(".galerey"),o=e.width()+20,i=e.height()+20;e.css("margin-top",-i/2+"px"),e.css("margin-left",-o/2+"px"),$(".loading").fadeOut(200),clearInterval(S)})})}),$(".galerey .close, .wrapp-galerey .galerey-bg").on("click",function(){$(".wrapp-galerey").fadeOut(200),unblockScroll(),clearInterval(S)});var O=$(".adr-2");$(".element-place:eq(1)").css("display","block"),$(".map:eq(1)").css("display","block"),$(".adr").on("click",function(){var e=$(this).index(".adr");0===$(this).data("active")&&($(".adr").removeClass("active-place"),$(".adr").attr("data-active","0"),$(this).addClass("active-place"),$(this).attr("data-active","1"),O=$(this),$(".element-place").css("display","none"),$(".element-place:eq("+e+")").css("display","block"),$(".map").css("display","none"),$(".map:eq("+e+")").css("display","block"))});var P=0;$(".map-title").on("click",function(){0===P?($(".form-obr-map").animate({bottom:"0px"},300),$(".map-title").animate({"padding-top":"15px"},300),$(".box-arrow img").css("transform","rotate(0deg)"),P=1):($(".form-obr-map").animate({bottom:"-104px"},300),$(".map-title").animate({"padding-top":"0px"},300),$(".box-arrow img").css("transform","rotate(180deg)"),P=0)}),blockScroll=function(){document.onmousewheel=document.onwheel=function(){return!1},document.addEventListener("MozMousePixelScroll",function(){return!1},!1),document.onkeydown=function(e){return e.keyCode>=33&&e.keyCode<=40?!1:void 0}},unblockScroll=function(){document.onmousewheel=document.onwheel=function(){return!0},document.addEventListener("MozMousePixelScroll",function(){return!1},!0),document.onkeydown=function(e){return e.keyCode>=33&&e.keyCode<=40?!0:void 0}};var P=0;$(".btn-obr, .elem-work:eq(0) p span").on("click",function(){$(".wrapp-modal-form").fadeIn(200),blockScroll(),M=1}),$(".modal-form-cont img, .bg-modal-form").on("click",function(){$(".wrapp-modal-form").fadeOut(200),unblockScroll(),_=0,M=0}),$(".phone, .phone-assort, #a, #b, #c, #d, #f, #e, #g, #h, #window, .phone-scale").keypress(function(e){return 8!=e.which&&0!=e.which&&(e.which<48||e.which>57)?!1:void 0}),$("input[type='submit']").click(function(e){e.preventDefault()});var Q=0,M=0,Q=0;success=function(){blockScroll(),$(".wrapp-modal-success").fadeIn(200),$(".text-form-suc").html("Спасибо за обращение, наш менеджер Вам перезвонит в ближайшее время!"),$(".icon-form-suc").attr("src","img/suc.png"),$(".success").css("display","block"),$(".error").css("display","none")},error=function(e){switch(blockScroll(),$(".wrapp-modal-success").fadeIn(200),e){case 0:$(".text-form-suc").text("Заполните поле “ваш телефон”"),$(".icon-form-suc").attr("src","img/err.png"),$(".success").css("display","none"),$(".error").css("display","block");break;case 1:$(".text-form-suc").text("Не менее шести цифр"),$(".icon-form-suc").attr("src","img/err.png"),$(".success").css("display","none"),$(".error").css("display","block");break;case 2:$(".text-form-suc").text("Все поля должны быть заполнены"),$(".icon-form-suc").attr("src","img/err.png"),$(".success").css("display","none"),$(".error").css("display","block")}};var _=0;$(".btn-obr-service").click(function(){M=1,_=$(this).index(".btn-obr-service"),_+=4,$(".wrapp-modal-form").fadeIn(200),blockScroll()}),$(".btn-obr-manager").click(function(){M=1,_=$(this).index(".btn-obr-manager"),_+=2,$(".wrapp-modal-form").fadeIn(200),blockScroll()}),$(".success").on("click",function(){$(".wrapp-modal-success").fadeOut(200),M=0,unblockScroll()}),$(".error").on("click",function(){$(".wrapp-modal-success").fadeOut(200),0===M&&unblockScroll(),1===Q&&$(".wrapp-modal-form").fadeIn(200)});var D;$(".button-assort").click(function(){var e=$(this).index(".button-assort"),o=$(".name-assort:eq("+e+")").val(),i=$(".phone-assort:eq("+e+")").val(),a=$(".button-assort:eq("+e+")").val(),t=$(".phone-assort:eq("+e+")").val().length,n=D;""==i?(error(0),Q=0):6>t?(error(1),Q=0):$.ajax({url:"../mailScript/mail.php",type:"POST",data:{name:o,phone:i,button:a,form:n},success:function(o){console.log(o,o[0]),o[0]?(success(),$(".form-assort:eq("+e+")").trigger("reset")):alert("Не отправлено")}})}),$(".button-scale").click(function(){var e=$(".name-scale").val(),o=$(".phone-scale").val(),i=$(".button-scale").val(),a=$("#a").val(),t=$("#b").val(),n=$("#c").val(),s=$("#d").val(),r=$("#e").val(),l=$("#f").val(),c=$("#g").val(),p=$("#h").val(),d=$("#window").val(),u=o.length;""==o?(error(0),Q=0):6>u?(error(1),Q=0):$.ajax({url:"../mailScript/mailScales.php",type:"POST",data:{name:e,phone:o,button:i,a_cont:a,b_cont:t,c_cont:n,d_cont:s,e_cont:r,f_cont:l,g_cont:c,h_cont:p,window_cont:d},success:function(e){console.log(e,e[0]),e[0]?(success(),$(".form-scale").trigger("reset")):alert("Не отправлено")}})}),$(".button").click(function(){var e,o=$(this).index(".button"),i=$(".name:eq("+o+")").val(),a=$(".phone:eq("+o+")").val(),t=$(".button:eq("+o+")").val(),n=a.length;e=0!=_?_:o,""==a?(error(0),1!=o?($(".wrapp-modal-form").fadeOut(200),Q=1):Q=0):6>n?(error(1),1!=o?($(".wrapp-modal-form").fadeOut(200),Q=1):Q=0):(1!=o&&$(".wrapp-modal-form").fadeOut(200),$.ajax({url:"../mailScript/mailModal.php",type:"POST",data:{name:i,phone:a,button:t,form:e},success:function(e){console.log(e,e[0]),e[0]?(success(),_=0,$(".form:eq("+o+")").trigger("reset")):alert("Не отправлено")}}))}),$("#btnQuestion").click(function(){var e=$("#mail").val(),o=$("#question").val(),i=$("#btnQuestion").val();form="Задать вопрос, отправив на email",""==e||""==o?(error(2),Q=0):$.ajax({url:"../mailScript/mailq1.php",type:"POST",data:{email:e,question:o,button:i,form:form},success:function(e){console.log(e,e[0]),e[0]?(success(),$("#formQuestion").trigger("reset")):alert("Не отправлено")}})}),$("#btnPhone").click(function(){var e=$("#phone5").val(),o=e.length,i=$("#btnPhone").val(),a="Отправить свой номер телефона";""==e?(error(0),Q=0):6>o?(error(1),Q=0):$.ajax({url:"../mailScript/mailq2.php",type:"POST",data:{phone:e,button:i,form:a},success:function(e){console.log(e,e[0]),e[0]?(success(),$("#formPhone").trigger("reset")):alert("Не отправлено")}})});var U=1;$(".buttonShow").on("click",function(){1==U?($(".wrappQuestions").stop().animate({right:"0px"},200),$(".arrowQuestion").css("background-position","0px 0px"),U=!U):($(".wrappQuestions").stop().animate({right:"-294px"},200),$(".arrowQuestion").css("background-position","13px 0px"),U=!U)});var z,W,E;$(".headerPunctQuestion").on("click",function(){var e=$(this).index(".headerPunctQuestion");W=e;var o=$(this).children("img").attr("src");"img/header/arrow-right-w.png"===o?$(this).children("img").attr("src","img/header/arrow-down.png"):$(this).children("img").attr("src","img/header/arrow-right-w.png"),null!=z&&(z.css("background",""),z.children("p").css("color","#37a332"),E!=W&&z.children("img").attr("src","img/header/arrow-right.png")),E=W,z=$(this).css("background","#37a332"),z.children("p").css("color","#fff"),$(".inform:eq("+e+")").stop().slideToggle(100).siblings(".inform:visible").slideUp(100)}),$(".headerPunctQuestion").hover(function(){var e=$(this).children("img").attr("src");"img/header/arrow-down.png"!=e&&$(this).children("img").attr("src","img/header/arrow-right-w.png")},function(){var e=($(this).children("img").attr("src"),$(this).index(".headerPunctQuestion"));e!=W&&$(this).children("img").attr("src","img/header/arrow-right.png")})});
